...
const Sidebar =  () => {
    return (
        <nav id="navbar">
            ...
            <ul>
                <li> <Link to="/dashboard"><div className="sidebar-item"><i className="nf nf-md-view_dashboard"></i>Dashboard</div></Link></li>
                <li><div className="sidebar-item"><i className="nf nf-cod-graph_line"></i>Stats</div></li>
                <li><Link to="/link"><div className="sidebar-item"><i className="nf nf-md-vector_link"></i>Link<br/>Accounts</div></Link></li>
            </ul>
